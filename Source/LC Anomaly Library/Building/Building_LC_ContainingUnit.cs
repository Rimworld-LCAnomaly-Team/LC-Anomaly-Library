...
namespace LCAnomalyLibrary.Building
{
    ...
    public class Building_LC_ContainingUnit : Verse.Building, IThingHolderWithDrawnPawn, IThingHolder, IRoofCollapseAlert, ISearchableContents
    {
        public struct Chain
        {
            public Vector3 from;
        ...
        private CompProperties_LC_EntityContainerUnit PlatformProps => GetComp<Comp_LC_EntityContainerUnit>().Props;
        ...
        public Building_LC_ContainingUnit()
        {
        ...
        public override void Tick()
        {
            ...
            {
                HeldPawn.TryGetComp<Comp_LC_ContainingUnitTarget>()?.Escape(initiator: false);
            }
        ...
        {
            if (HeldPawn.TryGetComp<Comp_LC_ContainingUnitTarget>(out var comp) && (!comp.Props.hasAnimation || HeldPawn.health.Downed))
            {
        ...
        public void EjectContents()
        {
            ...
            chains = null;
            HeldPawn?.Drawer.renderer.SetAnimation(null);
            HeldPawn?.GetComp<Comp_LC_ContainingUnitTarget>()?.Notify_ReleasedFromPlatform();
        ...
        public override string GetInspectString()
        {
            ...
            {
                string inspectStringExtraFor = Comp_LC_Studiable.GetInspectStringExtraFor(heldPawn);
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            if (HeldPawn != null && HeldPawn.TryGetComp<Comp_LC_Studiable>(out var comp2))
            {
            ...
            if (HeldPawn != null && HeldPawn.TryGetComp<Comp_LC_ContainingUnitTarget>(out var comp3))
            {
