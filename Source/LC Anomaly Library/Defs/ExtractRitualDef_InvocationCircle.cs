...
namespace LCAnomalyLibrary.Defs
{
        ...
        public static readonly SimpleCurve PsychicSensitivityToPowerFactor = new SimpleCurve
    {
        ...
        {
            new ExtractRitualToil_GatherForInvocation(psychicRitual, this, readOnlyDictionary),
        ...
        public override void CalculateMaxPower(PsychicRitualRoleAssignments assignments, List<QualityFactor> powerFactorsOut, out float power)
        {
            ...
            power += power2;
            if (assignments.Target.Thing is Verse.Building building)
            {
        ...
        private static void CalculateFacilityQualityOffset(List<QualityFactor> powerFactorsOut, ref float power, Verse.Building building)
        {
